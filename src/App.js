      ...
      <form class="form">
        <table>
          <tr>
            ...
            <td>
                <input class ="box" type="number" placeholder="movie year" value={selectedYear} onChange={handleYearChange} />
            </td> 
          </tr>
          <tr>
             
              <td>
                <input type="text" placeholder="Director name" value={selectedDirector} onChange={handleDirectorChange} />
              </td> 
          </tr>
          <tr>
